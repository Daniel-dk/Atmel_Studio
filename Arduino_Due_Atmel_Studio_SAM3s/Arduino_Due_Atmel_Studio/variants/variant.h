...
/*Daniel added this*/
#ifndef _VARIANT_ARDUINO_DUE_S_ // SAM3S4A ( 48 pin version )
#define _VARIANT_ARDUINO_DUE_S_
/*----------------------------------------------------------------------------
 *        Definitions
 *----------------------------------------------------------------------------*/

/** Frequency of the board main oscillator */
#define VARIANT_MAINOSC 12000000 // main osc input ( 12 MHz)

/** Master clock frequency */
#define VARIANT_MCK 64000000 //  main after the PLL ( 64 MHz)
...
#define PINS_COUNT (28u)// 26 GPIO pins ( its a 64 pin device)
...
/*
// these pin numbers are the Arduino numbers ( LED on DIO 13)
// LEDs
...
#define PIN_SPI_SS0 (28u)
#define PIN_SPI_MOSI (25u)
#define PIN_SPI_MISO (226u)
#define PIN_SPI_SCK (27u)
#define BOARD_SPI_SS0 (28u)
...
// Serial
#define PINS_UART (31u) // "all pins" mask
// Serial1
#define PINS_USART0 (32u) // "all pins" mask
// Serial2
#define PINS_UART1 (33u) // "all pins" mask
