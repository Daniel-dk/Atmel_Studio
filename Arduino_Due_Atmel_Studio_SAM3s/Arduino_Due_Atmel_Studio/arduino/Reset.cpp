...
void banzai() {
	...
	while (EFC->EEFC_FSR & EEFC_FSR_FRDY == 0); // while flash status  is NOT ready, wait or it
	EFC->EEFC_FCR = // flash status is ready now, write to the flash command register
